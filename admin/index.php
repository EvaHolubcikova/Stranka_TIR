...
<body style="background-color:pink;">
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card border-5 border-dark" style="background-color:lightblue;">
                    ...
                    <div class="card-body">
                        <form action="index.php" method="POST">
                            <div class="form-group row was-validated">
                                ...
                                <div class="input-group mx-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1" style="background-color:pink;">
                            ...
                            <div class="text-center" >
                                <button type="submit" class="btn mb-4" style="background-color:pink; color:white;">
                                    Prihlásiť sa
                                </button>
                                <br>
                                <a href="#" class="text-secondary">
                                    <small style="color: white;">Zaregistruj sa</small>
                                </a>
                                <br>
                                <a href="#" class="text-secondary">
                                    <small style="color: white;">Zabudol som heslo</small>
                                </a>
                            </div>
                    </div>
                    </form>
